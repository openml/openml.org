...
interface DatasetCodeMenukgglProps {
  datasetId: number;
  datasetName: string;
  className?: string;
}
...
/**
 * DatasetCodeMenukggl - kggl-style Code dropdown with language selector
 */
export function DatasetCodeMenukggl({
  datasetId,
  datasetName,
  className,
}: DatasetCodeMenukgglProps) {
