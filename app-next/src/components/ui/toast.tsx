...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={`text-foreground/50 hover:text-foreground absolute top-2 right-2 rounded-md p-1 opacity-100 transition-opacity group-[.destructive]:text-red-300 group-[.destructive]:hover:text-red-50 focus:ring-2 focus:outline-none group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600 ${className || ""}`}
    toast-close=""
    {...props}
  >
    <X className="h-4 w-4" />
