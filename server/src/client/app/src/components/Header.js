...
const Input = styled(InputBase)`
    ...
    > input {
        color: ${(props) =>
            props.bg === 'Gradient'
                ? 'white'
                : props.theme.header.search.color};
...
const UserButton = styled(Button)`
    ...
    color: ${(props) =>
        props.bg === 'Gradient' || props.currenttheme === 1
            ? 'white'
            : 'inherit'};
                    ...
                    <React.Fragment>
                        ...
                        >
                            ...
                            >
                                ...
                                <StyledLink to='/auth/upload-dataset'>
                                    New dataset
                                </StyledLink>
                            </StyledMenuItem>
                            <StyledMenuItem
                            ...
                            >
                                ...
                                <StyledLink to='/auth/upload-task'>
                                    New task
                                </StyledLink>
                            </StyledMenuItem>
                            <StyledMenuItem
                        ...
                        >
                            ...
                            >
                                ...
                                <StyledLink to='/auth/profile-page'>
                                    Your profile
                                </StyledLink>
                            </StyledMenuItem>
                            <StyledMenuItem
