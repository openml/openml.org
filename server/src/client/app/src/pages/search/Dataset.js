                            ...
                            <Grid item md={12}>
                                <Grid container display='flex' spacing={2}>
                                    ...
                                    <Grid item>
                                        <MetaTag
                                            type={'format'}
                                            value={this.props.object.format}
                                        />
                                    </Grid>
                                    <Grid item>
                                        <MetaTag
                                    ...
                                    >
                                        {this.props.object.kggl_url && (
                                            <Tooltip title='This dataset is also available on kggl. We integrate with kggl to give you the benefits of both platforms.'>
                                                <UserChip
                                                    size='small'
                                                    variant='outlined'
                                                    color='primary'
                                ...
                                <Grid container display='flex' spacing={2}>
                                            ...
                                            avatar={
                                                <Avatar>
                                                    {this.props.object.uploader
                                                        ? this.props.object.uploader.charAt(
                                                              0
                                                          )
                                                        : 'X'}
                                                </Avatar>
                                    ...
                                    <Grid item>
                                        <MetaTag
                                            type={'issues'}
                                            value={
                                                this.props.object.nr_of_issues +
                                                ' issues'
                                            }
                                        />
                                    </Grid>
                        ...
                        <Card>
                            <CardContent>
                                <CollapsibleDataTable
                                    title={
                                        this.props.object.features.length +
                                        ' Features'
                                    }
                    ...
                    <Grid item xs={12}>
                        <Card>
                            <CardContent>
                                <CollapsibleDataTable
                                    title={
                                        Object.keys(this.props.object.qualities)
                                            .length + ' Qualities'
                                    }
                                    data={Object.keys(
                                        this.props.object.qualities
                                    )}
                                    rowrenderer={(m) => (
                                        <QualityDetail
                                            key={'q_' + m}
