...
export class SearchResultsPanel extends React.Component {
  shouldComponentUpdate(nextProps, nextState) {
    ...
    if (
      nextProps.context.results.length >= 0 &&
      nextProps.context.updateType !== undefined
    ) {
      return true;
    } else if (
      this.props.context.displaySplit !== nextProps.context.displaySplit
    ) {
      return true;
    }
    return false;
  ...
  render() {
      ...
      if (qtype === "task" || (type === "task" && qtype === "task")) {
        return (
          <Box m={2} pt={3}>
            ...
            <Typography style={{ marginBottom: "15px" }}>
              Tasks define specific problems to be solved using{" "}
              {type === "task" ? (
                <span>a given dataset</span>
              ) : (
                <span>this {type}</span>
              )}
              . They specify train and test sets, which target feature(s) to
              predict for supervised problems, and possibly which evaluation
              measure to optimize. They make the problem reproducible and
              machine-readable.{"\u00A0"}
              <SimpleLink
                href="https://docs.openml.org/#tasks"
                style={{ color: this.props.context.getColor("task") }}
              >
                Learn more.{" "}
              </SimpleLink>
            </Typography>
        ...
        return (
          <Box m={2} pt={3}>
            ...
            <Typography style={{ marginBottom: "15px" }}>
              Datasets provide training data for machine learning models. OpenML
              datasets are uniformly formatted and come with rich meta-data to
              allow automated processing. You can{" "}
              <ColoredIcon
                color={this.props.context.getColor("data")}
              ...
              {"\u00A0"}
              <SimpleLink
                href="https://docs.openml.org/#data"
                style={{ color: this.props.context.getColor("data") }}
              >
                Learn more.{" "}
              </SimpleLink>
            </Typography>
        ...
        return (
          <Box m={2} pt={3}>
            ...
            <Typography style={{ marginBottom: "15px" }}>
              Flows represent machine learning pipelines or neural
              architectures, or (untrained) machine learning models, such as in
              general. Flows contain all the information necessary to build a
              model, including its exact structure and any software
              dependencies. Given a flow, supported machine learning libraries
              can reproduce the model exactly.{"\u00A0"}
              <SimpleLink
                href="https://docs.openml.org/#flows"
                style={{ color: this.props.context.getColor("flow") }}
              >
                Learn more.{" "}
              </SimpleLink>
            </Typography>
        ...
        return (
          <Box m={2} pt={3}>
            ...
            <Typography style={{ marginBottom: "15px" }}>
              ...
              {type === "run" ? (
                <span>a given task</span>
              ) : (
                <span>this {type}</span>
              )}
              . They can be created and shared automatically from supported
              ...
              {"\u00A0"}
              <SimpleLink
                href="https://docs.openml.org/#runs"
                style={{ color: this.props.context.getColor("run") }}
              >
                Learn more.{" "}
              </SimpleLink>
            </Typography>
        ...
        return (
          <Box m={2} pt={3}>
            ...
            <Typography style={{ marginBottom: "15px" }}>
              Task types define a machine-readable schema for specific machine
              learning tasks (e.g. classification). They define the required
              inputs and outputs, and how to describe them. Using this general
              schema, new tasks can be created on specific datasets, and all
              ensuing runs can be evaluated uniformly.
            </Typography>
          </Box>
        );
        ...
        return (
          <Box m={2} pt={3}>
            ...
            <Typography style={{ marginBottom: "15px" }}>
              You can group together tasks into collections to easily refer to
        ...
        return (
          <Box m={2} pt={3}>
            ...
            <Typography style={{ marginBottom: "15px" }}>
              You can group together runs into collections to easily refer to
              them and share them with others.
            </Typography>
          </Box>
        );
          ...
          <Box m={2} pt={3}>
            ...
            <Typography style={{ marginBottom: "15px" }}>
              <SimpleLink
                ...
                style={{ color: this.props.context.getColor("benchmark") }}
              >
                Benchmarking suites
              </SimpleLink>{" "}
              are comprehensive and curated collections of OpenML tasks designed
              to evaluate algorihms under well-defined conditions. They make it
              much easier to benchmark algorithms, and make the results
              objectively interpretable, comparable, and reproducible. You can
              also
              <StyledLink
                to="/auth/upload-collection-tasks"
                color={this.props.context.getColor("benchmark")}
              >
                create your own suites
              </StyledLink>
              .
            </Typography>
          </Box>
        ...
        return (
          <Box m={2} pt={3}>
            ...
            <Typography style={{ marginBottom: "15px" }}>
              Benchmarking studies are curated collections of OpenML runs
              obtained through a systematic evaluation of algorithms on a{" "}
              <SimpleLink
                href="https://docs.openml.org/benchmark"
                style={{ color: this.props.context.getColor("benchmark") }}
              >
              ...
              . The results can be viewed online (see their Analysis tab) or
              easily downloaded via our APIs and analyzed further. You can also
              <StyledLink
                to="/auth/upload-collection-tasks"
                color={this.props.context.getColor("benchmark")}
              >
                create your own benchmark studies
              </StyledLink>
              .
            </Typography>
          </Box>
        ...
        return (
          <Box m={2} pt={3}>
            ...
            <Typography style={{ marginBottom: "15px" }}>
              Data qualities are measureable properties of datasets, such as
              size, shape, statistical properties, benchmarks, and the presence
              of missing values.
            </Typography>
          </Box>
        );
        ...
        return (
          <Box m={2} pt={3}>
            ...
            <Typography style={{ marginBottom: "15px" }}>
              Evaluation measures define different ways to score the outputs of
              machine learning models (e.g. predictions).
            </Typography>
          </Box>
        );
        ...
        return (
          <Box m={2} pt={3}>
            ...
            <Typography style={{ marginBottom: "15px" }}>
              Evaluation procedures define how models should be evaluated,
              typically by defining specific kinds of train- and test splits.
            </Typography>
          </Box>
        );
      } else {
      ...
      if (this.props.context.updateType !== "query") {
        return (
          <React.Fragment>
            ...
            >
              <ColoredIcon
                color={this.props.context.getColor("run")}
                icon="heart"
                size="2x"
                fixedWidth
              />
              ...
              <StyledLink
                to="/auth/upload-task"
                color={this.props.context.getColor("task")}
              >
                {" "}
                tasks
              </StyledLink>
              ...
              <StyledLink
                to="/auth/upload-collection-tasks"
                color={this.props.context.getColor("study")}
              >
                {" "}
                collections
              </StyledLink>
    ...
    if (results.length >= 1 && results[0][id_field(qtype)] !== undefined) {
      component = results.map((result) => (
        <SearchElement
          ...
          id={result[qtype + "_id"]}
          selected={
            result[qtype + "_id"] + "" === this.props.context.id &&
            this.props.listType !== "drilldown"
          }
          onclick={() => this.props.selectEntity(result[id_field(qtype)] + "")}
      ...
      component = (
        <Card style={{ paddingLeft: 10 }}>No search results found</Card>
      );
    } else {
      component = <div></div>;
    }
    ...
    if (this.props.tag === undefined) {
      return (
        <React.Fragment>
          <SearchListPanel
            style={
              this.props.listType === "drilldown" ? { boxShadow: "none" } : {}
            }
          >
            <Scrollbar
              id={scrollID}
              style={{
                display:
                  this.props.context.displaySearch ||
                  this.props.listType === "drilldown"
                    ? "block"
                    : "none",
                height:
                  "calc(100vh - " +
                  (this.props.listType === "drilldown" ? "176" : "115") +
                  "px)",
              }}
            >
              <Grid
              ...
              >
                <Grid
                  item
                  xs={12}
                  md={this.props.context.displaySplit ? 12 : 10}
                ...
                >
                  <Grid
                    ...
                    direction="column"
                    style={{
                      paddingTop: this.props.context.displaySplit ? 0 : 20,
                    }}
                  >
                    {!this.props.context.displaySplit &&
                      (this.props.listType === "drilldown" ||
                        this.props.context.type === "benchmark" ||
                        this.props.context.type === "task" ||
                        this.props.context.type === "data" ||
                        this.props.context.type === "flow" ||
                        this.props.context.type === "run" ||
                        this.props.context.type === "study" ||
                        this.props.context.type === "measure" ||
                        this.props.context.type === "task_type") && (
                        // show header to explain what we're showing
                        <Grid item>
                          {header(
                            this.props.context.type,
                            qtype,
                            this.props.context.filters.study_type
                              ? this.props.context.filters.study_type.value
                              : null,
                            this.props.context.filters.measure_type
                              ? this.props.context.filters.measure_type.value
                              : null,
                          )}
                        </Grid>
                      )}
