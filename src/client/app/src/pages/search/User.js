        ...
        <div className="userPanel">
                <div className="userPanelDetails">
                      <div className="leftContentSection">
                            ...
                            (<img alt="user" src={this.props.object.image} width="130" height="130" className="userImage"></img>):
                            (<img alt="user" src="images/anonymousMan.png" width="130" height="130" className="userImage" ></img>) }
                      </div>
